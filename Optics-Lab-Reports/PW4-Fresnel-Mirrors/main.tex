...
\usepackage[utf8]{inputenc} % الترميز
\usepackage{amsmath,amsfonts,amssymb} % الرياضيات
\usepackage{float} % للحصول على [H]
\usepackage{caption}
\usepackage{booktabs} % جداول احترافية
\usepackage{pgfplots}
